...
public class PageHelper {
    ...
    public void changeElemStypeToFocusMode(WebElement toBeChangedElem){
        javascriptExecutor.executeScript("arguments[0].setAttribute('stype','border: 4px solid red')", toBeChangedElem);

    }
    public void changeElemStypeToFocusMode(WebElement toBeChangedElem, String customStype){
